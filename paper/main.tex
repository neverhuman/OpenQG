...
(chunks 1--2, both \texttt{planck\_mu0}-lane lineages; chunk 3's honest null was a
re-clothed $\Lambda$CDM baseline at 25.0). The 43-class decomposition
...
4--6 & \multicolumn{4}{l}{\emph{in flight on the pinned V7 binary}} \\
\bottomrule
\end{tabular}
\end{table}
