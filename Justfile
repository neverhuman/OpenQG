...
audit-baseline:
	"$HOME/.cargo/bin/jankurai" audit . --mode advisory --full --json target/jankurai/accepted-baseline.json --md target/jankurai/accepted-baseline.md

audit-ratchet:
	"$HOME/.cargo/bin/jankurai" audit . --mode ratchet --full --baseline target/jankurai/accepted-baseline.json --json target/jankurai/repo-score.json --md target/jankurai/repo-score.md
